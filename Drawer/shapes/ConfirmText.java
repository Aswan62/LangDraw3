...
public class ConfirmText extends AbstractShape {

	private Point2D point;
	public ConfirmText(Rectangle2D rectangle2d) {
		this.point = new Point2D.Float((float)rectangle2d.getMinX() + 40, (float)rectangle2d.getMaxY() + 30);
	}
	...
	protected Shape getShape() {
		...
		Shape shape = new TextLayout("Confirm", font, frc).getOutline(AffineTransform.getTranslateInstance(-2,0));
